...
pub struct Endpoint {
    ...
    pub targetRef: ::protobuf::MessageField<crate::v1_33::api::core::v1::ObjectReference>,
    #[serde(default)]
...
impl Endpoint {
    ...
    pub fn targetRef(&self) -> &crate::v1_33::api::core::v1::ObjectReference {
        self.targetRef.as_ref().unwrap_or_else(|| <crate::v1_33::api::core::v1::ObjectReference as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_targetRef(&mut self, v: crate::v1_33::api::core::v1::ObjectReference) {
        self.targetRef = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_targetRef(&mut self) -> &mut crate::v1_33::api::core::v1::ObjectReference {
        self.targetRef.mut_or_insert_default()
    }

    // Take field
    pub fn take_targetRef(&mut self) -> crate::v1_33::api::core::v1::ObjectReference {
        self.targetRef.take().unwrap_or_else(|| crate::v1_33::api::core::v1::ObjectReference::new())
    }
