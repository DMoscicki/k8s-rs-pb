...
pub struct HPAScalingRules {
    ...
    pub tolerance: ::protobuf::MessageField<crate::v1_33::apimachinery::pkg::api::resource::Quantity>,
    // special fields
    #[serde(skip)]
...
impl HPAScalingRules {
    ...
    pub fn tolerance(&self) -> &crate::v1_33::apimachinery::pkg::api::resource::Quantity {
        self.tolerance.as_ref().unwrap_or_else(|| <crate::v1_33::apimachinery::pkg::api::resource::Quantity as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_tolerance(&mut self, v: crate::v1_33::apimachinery::pkg::api::resource::Quantity) {
        self.tolerance = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_tolerance(&mut self) -> &mut crate::v1_33::apimachinery::pkg::api::resource::Quantity {
        self.tolerance.mut_or_insert_default()
    }

    // Take field
    pub fn take_tolerance(&mut self) -> crate::v1_33::apimachinery::pkg::api::resource::Quantity {
        self.tolerance.take().unwrap_or_else(|| crate::v1_33::apimachinery::pkg::api::resource::Quantity::new())
    }
