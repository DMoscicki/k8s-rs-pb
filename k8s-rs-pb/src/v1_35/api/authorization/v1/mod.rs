...
//! Generated file from `api/authorization/v1/generated.proto`
...
// @@protoc_insertion_point(message:api.authorization.v1.ExtraValue)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct ExtraValue {
    // message fields
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.ExtraValue.items)
    pub items: ::std::vec::Vec<::std::string::String>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.ExtraValue.special_fields)
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.FieldSelectorAttributes)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct FieldSelectorAttributes {
    // message fields
    // @@protoc_insertion_point(field:api.authorization.v1.FieldSelectorAttributes.rawSelector)
    pub rawSelector: ::std::option::Option<::std::string::String>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.FieldSelectorAttributes.requirements)
    pub requirements: ::std::vec::Vec<crate::v1_35::apimachinery::pkg::apis::meta::v1::FieldSelectorRequirement>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.FieldSelectorAttributes.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a FieldSelectorAttributes {
    fn default() -> &'a FieldSelectorAttributes {
        <FieldSelectorAttributes as ::protobuf::Message>::default_instance()
    }
}

impl FieldSelectorAttributes {
    pub fn new() -> FieldSelectorAttributes {
        ::std::default::Default::default()
    }

    // optional string rawSelector = 1;

    pub fn rawSelector(&self) -> &str {
        match self.rawSelector.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_rawSelector(&mut self) {
        self.rawSelector = ::std::option::Option::None;
    }

    pub fn has_rawSelector(&self) -> bool {
        self.rawSelector.is_some()
    }

    // Param is passed by value, moved
    pub fn set_rawSelector(&mut self, v: ::std::string::String) {
        self.rawSelector = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_rawSelector(&mut self) -> &mut ::std::string::String {
        if self.rawSelector.is_none() {
            self.rawSelector = ::std::option::Option::Some(::std::string::String::new());
        }
        self.rawSelector.as_mut().unwrap()
    }

    // Take field
    pub fn take_rawSelector(&mut self) -> ::std::string::String {
        self.rawSelector.take().unwrap_or_else(|| ::std::string::String::new())
    }

    // repeated .apimachinery.pkg.apis.meta.v1.FieldSelectorRequirement requirements = 2;

    pub fn requirements(&self) -> &[crate::v1_35::apimachinery::pkg::apis::meta::v1::FieldSelectorRequirement] {
        &self.requirements
    }
    ...
    // Param is passed by value, moved
    pub fn set_requirements(&mut self, v: ::std::vec::Vec<crate::v1_35::apimachinery::pkg::apis::meta::v1::FieldSelectorRequirement>) {
        self.requirements = v;
    }

    // Mutable pointer to the field.
    pub fn mut_requirements(&mut self) -> &mut ::std::vec::Vec<crate::v1_35::apimachinery::pkg::apis::meta::v1::FieldSelectorRequirement> {
        &mut self.requirements
    }

    // Take field
    pub fn take_requirements(&mut self) -> ::std::vec::Vec<crate::v1_35::apimachinery::pkg::apis::meta::v1::FieldSelectorRequirement> {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "rawSelector",
            |m: &FieldSelectorAttributes| { &m.rawSelector },
            |m: &mut FieldSelectorAttributes| { &mut m.rawSelector },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "requirements",
            |m: &FieldSelectorAttributes| { &m.requirements },
            |m: &mut FieldSelectorAttributes| { &mut m.requirements },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<FieldSelectorAttributes>(
...
impl ::protobuf::Message for FieldSelectorAttributes {
    const NAME: &'static str = "FieldSelectorAttributes";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.rawSelector = ::std::option::Option::Some(is.read_string()?);
                },
                18 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.rawSelector.as_ref() {
    ...
    fn new() -> FieldSelectorAttributes {
        FieldSelectorAttributes::new()
    }
    ...
    fn default_instance() -> &'static FieldSelectorAttributes {
        static instance: FieldSelectorAttributes = FieldSelectorAttributes {
            rawSelector: ::std::option::Option::None,
...
impl ::protobuf::MessageFull for FieldSelectorAttributes {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("FieldSelectorAttributes").unwrap()).clone()
    }
}

impl ::std::fmt::Display for FieldSelectorAttributes {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FieldSelectorAttributes {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.LabelSelectorAttributes)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LabelSelectorAttributes {
    // message fields
    // @@protoc_insertion_point(field:api.authorization.v1.LabelSelectorAttributes.rawSelector)
    pub rawSelector: ::std::option::Option<::std::string::String>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.LabelSelectorAttributes.requirements)
    pub requirements: ::std::vec::Vec<crate::v1_35::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.LabelSelectorAttributes.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a LabelSelectorAttributes {
    fn default() -> &'a LabelSelectorAttributes {
        <LabelSelectorAttributes as ::protobuf::Message>::default_instance()
    }
}

impl LabelSelectorAttributes {
    pub fn new() -> LabelSelectorAttributes {
        ::std::default::Default::default()
    }
    ...
    // repeated .apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement requirements = 2;

    pub fn requirements(&self) -> &[crate::v1_35::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement] {
        &self.requirements
    }
    ...
    // Param is passed by value, moved
    pub fn set_requirements(&mut self, v: ::std::vec::Vec<crate::v1_35::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement>) {
        self.requirements = v;
    }

    // Mutable pointer to the field.
    pub fn mut_requirements(&mut self) -> &mut ::std::vec::Vec<crate::v1_35::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement> {
        &mut self.requirements
    }

    // Take field
    pub fn take_requirements(&mut self) -> ::std::vec::Vec<crate::v1_35::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement> {
        ::std::mem::replace(&mut self.requirements, ::std::vec::Vec::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "rawSelector",
            |m: &LabelSelectorAttributes| { &m.rawSelector },
            |m: &mut LabelSelectorAttributes| { &mut m.rawSelector },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "requirements",
            |m: &LabelSelectorAttributes| { &m.requirements },
            |m: &mut LabelSelectorAttributes| { &mut m.requirements },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<LabelSelectorAttributes>(
...
impl ::protobuf::Message for LabelSelectorAttributes {
    const NAME: &'static str = "LabelSelectorAttributes";
    ...
    fn new() -> LabelSelectorAttributes {
        LabelSelectorAttributes::new()
    }
    ...
    fn default_instance() -> &'static LabelSelectorAttributes {
        static instance: LabelSelectorAttributes = LabelSelectorAttributes {
            rawSelector: ::std::option::Option::None,
            requirements: ::std::vec::Vec::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
...
impl ::protobuf::MessageFull for LabelSelectorAttributes {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LabelSelectorAttributes").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LabelSelectorAttributes {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LabelSelectorAttributes {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.LocalSubjectAccessReview)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LocalSubjectAccessReview {
    // message fields
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.LocalSubjectAccessReview.metadata)
    pub metadata: ::protobuf::MessageField<crate::v1_35::apimachinery::pkg::apis::meta::v1::ObjectMeta>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.LocalSubjectAccessReview.spec)
    pub spec: ::protobuf::MessageField<SubjectAccessReviewSpec>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.LocalSubjectAccessReview.status)
    pub status: ::protobuf::MessageField<SubjectAccessReviewStatus>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.LocalSubjectAccessReview.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl LocalSubjectAccessReview {
    ...
    // optional .api.authorization.v1.SubjectAccessReviewSpec spec = 2;
    ...
    // optional .api.authorization.v1.SubjectAccessReviewStatus status = 3;
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.NonResourceAttributes)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct NonResourceAttributes {
    // message fields
    // @@protoc_insertion_point(field:api.authorization.v1.NonResourceAttributes.path)
    pub path: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:api.authorization.v1.NonResourceAttributes.verb)
    pub verb: ::std::option::Option<::std::string::String>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.NonResourceAttributes.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.NonResourceRule)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct NonResourceRule {
    // message fields
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.NonResourceRule.verbs)
    pub verbs: ::std::vec::Vec<::std::string::String>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.NonResourceRule.nonResourceURLs)
    pub nonResourceURLs: ::std::vec::Vec<::std::string::String>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.NonResourceRule.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.ResourceAttributes)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct ResourceAttributes {
    // message fields
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceAttributes.namespace)
    pub namespace: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceAttributes.verb)
    pub verb: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceAttributes.group)
    pub group: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceAttributes.version)
    pub version: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceAttributes.resource)
    pub resource: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceAttributes.subresource)
    pub subresource: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceAttributes.name)
    pub name: ::std::option::Option<::std::string::String>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceAttributes.fieldSelector)
    pub fieldSelector: ::protobuf::MessageField<FieldSelectorAttributes>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceAttributes.labelSelector)
    pub labelSelector: ::protobuf::MessageField<LabelSelectorAttributes>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.ResourceAttributes.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl ResourceAttributes {
    ...
    // optional .api.authorization.v1.FieldSelectorAttributes fieldSelector = 8;

    pub fn fieldSelector(&self) -> &FieldSelectorAttributes {
        self.fieldSelector.as_ref().unwrap_or_else(|| <FieldSelectorAttributes as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_fieldSelector(&mut self, v: FieldSelectorAttributes) {
        self.fieldSelector = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_fieldSelector(&mut self) -> &mut FieldSelectorAttributes {
        self.fieldSelector.mut_or_insert_default()
    }

    // Take field
    pub fn take_fieldSelector(&mut self) -> FieldSelectorAttributes {
        self.fieldSelector.take().unwrap_or_else(|| FieldSelectorAttributes::new())
    }

    // optional .api.authorization.v1.LabelSelectorAttributes labelSelector = 9;

    pub fn labelSelector(&self) -> &LabelSelectorAttributes {
        self.labelSelector.as_ref().unwrap_or_else(|| <LabelSelectorAttributes as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_labelSelector(&mut self, v: LabelSelectorAttributes) {
        self.labelSelector = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_labelSelector(&mut self) -> &mut LabelSelectorAttributes {
        self.labelSelector.mut_or_insert_default()
    }

    // Take field
    pub fn take_labelSelector(&mut self) -> LabelSelectorAttributes {
        self.labelSelector.take().unwrap_or_else(|| LabelSelectorAttributes::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, FieldSelectorAttributes>(
            "fieldSelector",
            |m: &ResourceAttributes| { &m.fieldSelector },
            |m: &mut ResourceAttributes| { &mut m.fieldSelector },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, LabelSelectorAttributes>(
            "labelSelector",
            |m: &ResourceAttributes| { &m.labelSelector },
            |m: &mut ResourceAttributes| { &mut m.labelSelector },
        ));
...
impl ::protobuf::Message for ResourceAttributes {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                66 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.fieldSelector)?;
                },
                74 => {
    ...
    fn default_instance() -> &'static ResourceAttributes {
        static instance: ResourceAttributes = ResourceAttributes {
            ...
            fieldSelector: ::protobuf::MessageField::none(),
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.ResourceRule)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct ResourceRule {
    // message fields
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceRule.verbs)
    pub verbs: ::std::vec::Vec<::std::string::String>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceRule.apiGroups)
    pub apiGroups: ::std::vec::Vec<::std::string::String>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceRule.resources)
    pub resources: ::std::vec::Vec<::std::string::String>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.ResourceRule.resourceNames)
    pub resourceNames: ::std::vec::Vec<::std::string::String>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.ResourceRule.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.SelfSubjectAccessReview)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SelfSubjectAccessReview {
    // message fields
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SelfSubjectAccessReview.metadata)
    pub metadata: ::protobuf::MessageField<crate::v1_35::apimachinery::pkg::apis::meta::v1::ObjectMeta>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SelfSubjectAccessReview.spec)
    pub spec: ::protobuf::MessageField<SelfSubjectAccessReviewSpec>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SelfSubjectAccessReview.status)
    pub status: ::protobuf::MessageField<SubjectAccessReviewStatus>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.SelfSubjectAccessReview.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl SelfSubjectAccessReview {
    ...
    // optional .api.authorization.v1.SelfSubjectAccessReviewSpec spec = 2;
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.SelfSubjectAccessReviewSpec)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SelfSubjectAccessReviewSpec {
    // message fields
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SelfSubjectAccessReviewSpec.resourceAttributes)
    pub resourceAttributes: ::protobuf::MessageField<ResourceAttributes>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SelfSubjectAccessReviewSpec.nonResourceAttributes)
    pub nonResourceAttributes: ::protobuf::MessageField<NonResourceAttributes>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.SelfSubjectAccessReviewSpec.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl SelfSubjectAccessReviewSpec {
    ...
    // optional .api.authorization.v1.ResourceAttributes resourceAttributes = 1;
    ...
    // optional .api.authorization.v1.NonResourceAttributes nonResourceAttributes = 2;
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.SelfSubjectRulesReview)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SelfSubjectRulesReview {
    // message fields
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SelfSubjectRulesReview.metadata)
    pub metadata: ::protobuf::MessageField<crate::v1_35::apimachinery::pkg::apis::meta::v1::ObjectMeta>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SelfSubjectRulesReview.spec)
    pub spec: ::protobuf::MessageField<SelfSubjectRulesReviewSpec>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SelfSubjectRulesReview.status)
    pub status: ::protobuf::MessageField<SubjectRulesReviewStatus>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.SelfSubjectRulesReview.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl SelfSubjectRulesReview {
    ...
    // optional .api.authorization.v1.SelfSubjectRulesReviewSpec spec = 2;
    ...
    // optional .api.authorization.v1.SubjectRulesReviewStatus status = 3;
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.SelfSubjectRulesReviewSpec)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SelfSubjectRulesReviewSpec {
    // message fields
    // @@protoc_insertion_point(field:api.authorization.v1.SelfSubjectRulesReviewSpec.namespace)
    pub namespace: ::std::option::Option<::std::string::String>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.SelfSubjectRulesReviewSpec.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.SubjectAccessReview)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SubjectAccessReview {
    // message fields
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReview.metadata)
    pub metadata: ::protobuf::MessageField<crate::v1_35::apimachinery::pkg::apis::meta::v1::ObjectMeta>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReview.spec)
    pub spec: ::protobuf::MessageField<SubjectAccessReviewSpec>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReview.status)
    pub status: ::protobuf::MessageField<SubjectAccessReviewStatus>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.SubjectAccessReview.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.SubjectAccessReviewSpec)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SubjectAccessReviewSpec {
    // message fields
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewSpec.resourceAttributes)
    pub resourceAttributes: ::protobuf::MessageField<ResourceAttributes>,
    #[serde(with = "crate::v1_35::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewSpec.nonResourceAttributes)
    pub nonResourceAttributes: ::protobuf::MessageField<NonResourceAttributes>,
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewSpec.user)
    pub user: ::std::option::Option<::std::string::String>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewSpec.groups)
    pub groups: ::std::vec::Vec<::std::string::String>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewSpec.extra)
    pub extra: ::std::collections::BTreeMap<::std::string::String, ExtraValue>,
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewSpec.uid)
    pub uid: ::std::option::Option<::std::string::String>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.SubjectAccessReviewSpec.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl SubjectAccessReviewSpec {
    ...
    // repeated .api.authorization.v1.SubjectAccessReviewSpec.ExtraEntry extra = 5;
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "groups",
            |m: &SubjectAccessReviewSpec| { &m.groups },
            |m: &mut SubjectAccessReviewSpec| { &mut m.groups },
        ));
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.SubjectAccessReviewStatus)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SubjectAccessReviewStatus {
    // message fields
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewStatus.allowed)
    pub allowed: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewStatus.denied)
    pub denied: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewStatus.reason)
    pub reason: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectAccessReviewStatus.evaluationError)
    pub evaluationError: ::std::option::Option<::std::string::String>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.SubjectAccessReviewStatus.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.authorization.v1.SubjectRulesReviewStatus)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SubjectRulesReviewStatus {
    // message fields
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectRulesReviewStatus.resourceRules)
    pub resourceRules: ::std::vec::Vec<ResourceRule>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectRulesReviewStatus.nonResourceRules)
    pub nonResourceRules: ::std::vec::Vec<NonResourceRule>,
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectRulesReviewStatus.incomplete)
    pub incomplete: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:api.authorization.v1.SubjectRulesReviewStatus.evaluationError)
    pub evaluationError: ::std::option::Option<::std::string::String>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.authorization.v1.SubjectRulesReviewStatus.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl SubjectRulesReviewStatus {
    ...
    // repeated .api.authorization.v1.ResourceRule resourceRules = 1;
    ...
    // repeated .api.authorization.v1.NonResourceRule nonResourceRules = 2;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n$api/authorization/v1/generated.proto\x12\x14api.authorization.v1\x1a-\
    ...
    \"\n\nExtraValue\x12\x14\n\x05items\x18\x01\x20\x03(\tR\x05items\"\x98\
    \x01\n\x17FieldSelectorAttributes\x12\x20\n\x0brawSelector\x18\x01\x20\
    \x01(\tR\x0brawSelector\x12[\n\x0crequirements\x18\x02\x20\x03(\x0b27.ap\
    imachinery.pkg.apis.meta.v1.FieldSelectorRequirementR\x0crequirements\"\
    \x98\x01\n\x17LabelSelectorAttributes\x12\x20\n\x0brawSelector\x18\x01\
    \x20\x01(\tR\x0brawSelector\x12[\n\x0crequirements\x18\x02\x20\x03(\x0b2\
    7.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirementR\x0crequirement\
    s\"\xed\x01\n\x18LocalSubjectAccessReview\x12E\n\x08metadata\x18\x01\x20\
    \x01(\x0b2).apimachinery.pkg.apis.meta.v1.ObjectMetaR\x08metadata\x12A\n\
    \x04spec\x18\x02\x20\x01(\x0b2-.api.authorization.v1.SubjectAccessReview\
    SpecR\x04spec\x12G\n\x06status\x18\x03\x20\x01(\x0b2/.api.authorization.\
    v1.SubjectAccessReviewStatusR\x06status\"?\n\x15NonResourceAttributes\
    \x12\x12\n\x04path\x18\x01\x20\x01(\tR\x04path\x12\x12\n\x04verb\x18\x02\
    \x20\x01(\tR\x04verb\"Q\n\x0fNonResourceRule\x12\x14\n\x05verbs\x18\x01\
    \x20\x03(\tR\x05verbs\x12(\n\x0fnonResourceURLs\x18\x02\x20\x03(\tR\x0fn\
    onResourceURLs\"\xf2\x02\n\x12ResourceAttributes\x12\x1c\n\tnamespace\
    \x18\x01\x20\x01(\tR\tnamespace\x12\x12\n\x04verb\x18\x02\x20\x01(\tR\
    \x04verb\x12\x14\n\x05group\x18\x03\x20\x01(\tR\x05group\x12\x18\n\x07ve\
    rsion\x18\x04\x20\x01(\tR\x07version\x12\x1a\n\x08resource\x18\x05\x20\
    \x01(\tR\x08resource\x12\x20\n\x0bsubresource\x18\x06\x20\x01(\tR\x0bsub\
    resource\x12\x12\n\x04name\x18\x07\x20\x01(\tR\x04name\x12S\n\rfieldSele\
    ctor\x18\x08\x20\x01(\x0b2-.api.authorization.v1.FieldSelectorAttributes\
    R\rfieldSelector\x12S\n\rlabelSelector\x18\t\x20\x01(\x0b2-.api.authoriz\
    ation.v1.LabelSelectorAttributesR\rlabelSelector\"\x86\x01\n\x0cResource\
    Rule\x12\x14\n\x05verbs\x18\x01\x20\x03(\tR\x05verbs\x12\x1c\n\tapiGroup\
    s\x18\x02\x20\x03(\tR\tapiGroups\x12\x1c\n\tresources\x18\x03\x20\x03(\t\
    R\tresources\x12$\n\rresourceNames\x18\x04\x20\x03(\tR\rresourceNames\"\
    \xf0\x01\n\x17SelfSubjectAccessReview\x12E\n\x08metadata\x18\x01\x20\x01\
    (\x0b2).apimachinery.pkg.apis.meta.v1.ObjectMetaR\x08metadata\x12E\n\x04\
    spec\x18\x02\x20\x01(\x0b21.api.authorization.v1.SelfSubjectAccessReview\
    SpecR\x04spec\x12G\n\x06status\x18\x03\x20\x01(\x0b2/.api.authorization.\
    v1.SubjectAccessReviewStatusR\x06status\"\xda\x01\n\x1bSelfSubjectAccess\
    ReviewSpec\x12X\n\x12resourceAttributes\x18\x01\x20\x01(\x0b2(.api.autho\
    rization.v1.ResourceAttributesR\x12resourceAttributes\x12a\n\x15nonResou\
    rceAttributes\x18\x02\x20\x01(\x0b2+.api.authorization.v1.NonResourceAtt\
    ributesR\x15nonResourceAttributes\"\xed\x01\n\x16SelfSubjectRulesReview\
    \x12E\n\x08metadata\x18\x01\x20\x01(\x0b2).apimachinery.pkg.apis.meta.v1\
    .ObjectMetaR\x08metadata\x12D\n\x04spec\x18\x02\x20\x01(\x0b20.api.autho\
    rization.v1.SelfSubjectRulesReviewSpecR\x04spec\x12F\n\x06status\x18\x03\
    \x20\x01(\x0b2..api.authorization.v1.SubjectRulesReviewStatusR\x06status\
    \":\n\x1aSelfSubjectRulesReviewSpec\x12\x1c\n\tnamespace\x18\x01\x20\x01\
    (\tR\tnamespace\"\xe8\x01\n\x13SubjectAccessReview\x12E\n\x08metadata\
    \x18\x01\x20\x01(\x0b2).apimachinery.pkg.apis.meta.v1.ObjectMetaR\x08met\
    adata\x12A\n\x04spec\x18\x02\x20\x01(\x0b2-.api.authorization.v1.Subject\
    AccessReviewSpecR\x04spec\x12G\n\x06status\x18\x03\x20\x01(\x0b2/.api.au\
    thorization.v1.SubjectAccessReviewStatusR\x06status\"\xc0\x03\n\x17Subje\
    ctAccessReviewSpec\x12X\n\x12resourceAttributes\x18\x01\x20\x01(\x0b2(.a\
    pi.authorization.v1.ResourceAttributesR\x12resourceAttributes\x12a\n\x15\
    nonResourceAttributes\x18\x02\x20\x01(\x0b2+.api.authorization.v1.NonRes\
    ourceAttributesR\x15nonResourceAttributes\x12\x12\n\x04user\x18\x03\x20\
    \x01(\tR\x04user\x12\x16\n\x06groups\x18\x04\x20\x03(\tR\x06groups\x12N\
    \n\x05extra\x18\x05\x20\x03(\x0b28.api.authorization.v1.SubjectAccessRev\
    iewSpec.ExtraEntryR\x05extra\x12\x10\n\x03uid\x18\x06\x20\x01(\tR\x03uid\
    \x1aZ\n\nExtraEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x126\n\
    \x05value\x18\x02\x20\x01(\x0b2\x20.api.authorization.v1.ExtraValueR\x05\
    value:\x028\x01\"\x8f\x01\n\x19SubjectAccessReviewStatus\x12\x18\n\x07al\
    lowed\x18\x01\x20\x01(\x08R\x07allowed\x12\x16\n\x06denied\x18\x04\x20\
    \x01(\x08R\x06denied\x12\x16\n\x06reason\x18\x02\x20\x01(\tR\x06reason\
    \x12(\n\x0fevaluationError\x18\x03\x20\x01(\tR\x0fevaluationError\"\x81\
    \x02\n\x18SubjectRulesReviewStatus\x12H\n\rresourceRules\x18\x01\x20\x03\
    (\x0b2\".api.authorization.v1.ResourceRuleR\rresourceRules\x12Q\n\x10non\
    ResourceRules\x18\x02\x20\x03(\x0b2%.api.authorization.v1.NonResourceRul\
    eR\x10nonResourceRules\x12\x1e\n\nincomplete\x18\x03\x20\x01(\x08R\ninco\
    mplete\x12(\n\x0fevaluationError\x18\x04\x20\x01(\tR\x0fevaluationErrorB\
    \x1dZ\x1bk8s.io/api/authorization/v1\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(FieldSelectorAttributes::generated_message_descriptor_data());
            messages.push(LabelSelectorAttributes::generated_message_descriptor_data());
