...
pub struct List {
    ...
    pub items: ::std::vec::Vec<crate::apimachinery::pkg::runtime::RawExtension>,
    // special fields
    #[serde(skip)]
...
impl List {
    ...
    pub fn items(&self) -> &[crate::apimachinery::pkg::runtime::RawExtension] {
        &self.items
    }
    ...
    // Param is passed by value, moved
    pub fn set_items(&mut self, v: ::std::vec::Vec<crate::apimachinery::pkg::runtime::RawExtension>) {
        self.items = v;
    }

    // Mutable pointer to the field.
    pub fn mut_items(&mut self) -> &mut ::std::vec::Vec<crate::apimachinery::pkg::runtime::RawExtension> {
        &mut self.items
    }

    // Take field
    pub fn take_items(&mut self) -> ::std::vec::Vec<crate::apimachinery::pkg::runtime::RawExtension> {
