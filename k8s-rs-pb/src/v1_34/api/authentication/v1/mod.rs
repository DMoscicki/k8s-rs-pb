...
pub struct TokenRequestStatus {
    ...
    pub expirationTimestamp: ::protobuf::MessageField<crate::v1_34::apimachinery::pkg::apis::meta::v1::Time>,
    // special fields
    #[serde(skip)]
...
impl TokenRequestStatus {
    ...
    pub fn expirationTimestamp(&self) -> &crate::v1_34::apimachinery::pkg::apis::meta::v1::Time {
        self.expirationTimestamp.as_ref().unwrap_or_else(|| <crate::v1_34::apimachinery::pkg::apis::meta::v1::Time as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_expirationTimestamp(&mut self, v: crate::v1_34::apimachinery::pkg::apis::meta::v1::Time) {
        self.expirationTimestamp = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_expirationTimestamp(&mut self) -> &mut crate::v1_34::apimachinery::pkg::apis::meta::v1::Time {
        self.expirationTimestamp.mut_or_insert_default()
    }

    // Take field
    pub fn take_expirationTimestamp(&mut self) -> crate::v1_34::apimachinery::pkg::apis::meta::v1::Time {
        self.expirationTimestamp.take().unwrap_or_else(|| crate::v1_34::apimachinery::pkg::apis::meta::v1::Time::new())
    }
