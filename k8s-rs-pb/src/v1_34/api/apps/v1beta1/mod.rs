...
pub struct DeploymentStatus {
    ...
    // @@protoc_insertion_point(field:api.apps.v1beta1.DeploymentStatus.terminatingReplicas)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x17progressDeadlineSeconds\"\xaf\x03\n\x10DeploymentStatus\x12.\n\x12ob\
    ...
    \x20\x01(\x05R\x13unavailableReplicas\x120\n\x13terminatingReplicas\x18\
    \t\x20\x01(\x05R\x13terminatingReplicas\x12E\n\nconditions\x18\x06\x20\
    \x03(\x0b2%.api.apps.v1beta1.DeploymentConditionR\nconditions\x12&\n\x0e\
    collisionCount\x18\x08\x20\x01(\x05R\x0ecollisionCount\"y\n\x12Deploymen\
    tStrategy\x12\x12\n\x04type\x18\x01\x20\x01(\tR\x04type\x12O\n\rrollingU\
    pdate\x18\x02\x20\x01(\x0b2).api.apps.v1beta1.RollingUpdateDeploymentR\r\
    rollingUpdate\",\n\x0eRollbackConfig\x12\x1a\n\x08revision\x18\x01\x20\
    \x01(\x03R\x08revision\"\xb3\x01\n\x17RollingUpdateDeployment\x12Q\n\x0e\
    maxUnavailable\x18\x01\x20\x01(\x0b2).apimachinery.pkg.util.intstr.IntOr\
    StringR\x0emaxUnavailable\x12E\n\x08maxSurge\x18\x02\x20\x01(\x0b2).apim\
    achinery.pkg.util.intstr.IntOrStringR\x08maxSurge\"\x93\x01\n\x20Rolling\
    UpdateStatefulSetStrategy\x12\x1c\n\tpartition\x18\x01\x20\x01(\x05R\tpa\
    rtition\x12Q\n\x0emaxUnavailable\x18\x02\x20\x01(\x0b2).apimachinery.pkg\
    .util.intstr.IntOrStringR\x0emaxUnavailable\"\xb6\x01\n\x05Scale\x12E\n\
    \x08metadata\x18\x01\x20\x01(\x0b2).apimachinery.pkg.apis.meta.v1.Object\
    MetaR\x08metadata\x12/\n\x04spec\x18\x02\x20\x01(\x0b2\x1b.api.apps.v1be\
    ta1.ScaleSpecR\x04spec\x125\n\x06status\x18\x03\x20\x01(\x0b2\x1d.api.ap\
    ps.v1beta1.ScaleStatusR\x06status\"'\n\tScaleSpec\x12\x1a\n\x08replicas\
    \x18\x01\x20\x01(\x05R\x08replicas\"\xd7\x01\n\x0bScaleStatus\x12\x1a\n\
    \x08replicas\x18\x01\x20\x01(\x05R\x08replicas\x12G\n\x08selector\x18\
    \x02\x20\x03(\x0b2+.api.apps.v1beta1.ScaleStatus.SelectorEntryR\x08selec\
    tor\x12&\n\x0etargetSelector\x18\x03\x20\x01(\tR\x0etargetSelector\x1a;\
    \n\rSelectorEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\
    \x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01\"\xc8\x01\n\x0bStateful\
    Set\x12E\n\x08metadata\x18\x01\x20\x01(\x0b2).apimachinery.pkg.apis.meta\
    .v1.ObjectMetaR\x08metadata\x125\n\x04spec\x18\x02\x20\x01(\x0b2!.api.ap\
    ps.v1beta1.StatefulSetSpecR\x04spec\x12;\n\x06status\x18\x03\x20\x01(\
    \x0b2#.api.apps.v1beta1.StatefulSetStatusR\x06status\"\xc9\x01\n\x14Stat\
    efulSetCondition\x12\x12\n\x04type\x18\x01\x20\x01(\tR\x04type\x12\x16\n\
    ...
    1.ListMetaR\x08metadata\x123\n\x05items\x18\x02\x20\x03(\x0b2\x1d.api.ap\
    ps.v1beta1.StatefulSetR\x05items\"+\n\x13StatefulSetOrdinals\x12\x14\n\
    \x05start\x18\x01\x20\x01(\x05R\x05start\"s\n/StatefulSetPersistentVolum\
    eClaimRetentionPolicy\x12\x20\n\x0bwhenDeleted\x18\x01\x20\x01(\tR\x0bwh\
    ...
    \x01(\x0b2\x1c.api.core.v1.PodTemplateSpecR\x08template\x12V\n\x14volume\
    ClaimTemplates\x18\x04\x20\x03(\x0b2\".api.core.v1.PersistentVolumeClaim\
    R\x14volumeClaimTemplates\x12\x20\n\x0bserviceName\x18\x05\x20\x01(\tR\
    \x0bserviceName\x120\n\x13podManagementPolicy\x18\x06\x20\x01(\tR\x13pod\
    ManagementPolicy\x12S\n\x0eupdateStrategy\x18\x07\x20\x01(\x0b2+.api.app\
    s.v1beta1.StatefulSetUpdateStrategyR\x0eupdateStrategy\x122\n\x14revisio\
    nHistoryLimit\x18\x08\x20\x01(\x05R\x14revisionHistoryLimit\x12(\n\x0fmi\
    nReadySeconds\x18\t\x20\x01(\x05R\x0fminReadySeconds\x12\x95\x01\n$persi\
    stentVolumeClaimRetentionPolicy\x18\n\x20\x01(\x0b2A.api.apps.v1beta1.St\
    atefulSetPersistentVolumeClaimRetentionPolicyR$persistentVolumeClaimRete\
    ntionPolicy\x12A\n\x08ordinals\x18\x0b\x20\x01(\x0b2%.api.apps.v1beta1.S\
    tatefulSetOrdinalsR\x08ordinals\"\xc9\x03\n\x11StatefulSetStatus\x12.\n\
    \x12observedGeneration\x18\x01\x20\x01(\x03R\x12observedGeneration\x12\
    \x1a\n\x08replicas\x18\x02\x20\x01(\x05R\x08replicas\x12$\n\rreadyReplic\
    as\x18\x03\x20\x01(\x05R\rreadyReplicas\x12(\n\x0fcurrentReplicas\x18\
    \x04\x20\x01(\x05R\x0fcurrentReplicas\x12(\n\x0fupdatedReplicas\x18\x05\
    \x20\x01(\x05R\x0fupdatedReplicas\x12(\n\x0fcurrentRevision\x18\x06\x20\
    \x01(\tR\x0fcurrentRevision\x12&\n\x0eupdateRevision\x18\x07\x20\x01(\tR\
    \x0eupdateRevision\x12&\n\x0ecollisionCount\x18\t\x20\x01(\x05R\x0ecolli\
    sionCount\x12F\n\nconditions\x18\n\x20\x03(\x0b2&.api.apps.v1beta1.State\
    fulSetConditionR\nconditions\x12,\n\x11availableReplicas\x18\x0b\x20\x01\
    (\x05R\x11availableReplicas\"\x89\x01\n\x19StatefulSetUpdateStrategy\x12\
    \x12\n\x04type\x18\x01\x20\x01(\tR\x04type\x12X\n\rrollingUpdate\x18\x02\
    \x20\x01(\x0b22.api.apps.v1beta1.RollingUpdateStatefulSetStrategyR\rroll\
    ingUpdateB\x19Z\x17k8s.io/api/apps/v1beta1\
";
