...
pub struct HPAScalingRules {
    ...
    #[serde(with = "crate::v1_34::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.autoscaling.v2.HPAScalingRules.tolerance)
    pub tolerance: ::protobuf::MessageField<crate::v1_34::apimachinery::pkg::api::resource::Quantity>,
    // special fields
    #[serde(skip)]
...
impl HPAScalingRules {
    ...
    // optional .apimachinery.pkg.api.resource.Quantity tolerance = 4;

    pub fn tolerance(&self) -> &crate::v1_34::apimachinery::pkg::api::resource::Quantity {
        self.tolerance.as_ref().unwrap_or_else(|| <crate::v1_34::apimachinery::pkg::api::resource::Quantity as ::protobuf::Message>::default_instance())
    }

    pub fn clear_tolerance(&mut self) {
    ...
    // Param is passed by value, moved
    pub fn set_tolerance(&mut self, v: crate::v1_34::apimachinery::pkg::api::resource::Quantity) {
        self.tolerance = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_tolerance(&mut self) -> &mut crate::v1_34::apimachinery::pkg::api::resource::Quantity {
        self.tolerance.mut_or_insert_default()
    }

    // Take field
    pub fn take_tolerance(&mut self) -> crate::v1_34::apimachinery::pkg::api::resource::Quantity {
        self.tolerance.take().unwrap_or_else(|| crate::v1_34::apimachinery::pkg::api::resource::Quantity::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, crate::v1_34::apimachinery::pkg::api::resource::Quantity>(
            "tolerance",
            |m: &HPAScalingRules| { &m.tolerance },
            |m: &mut HPAScalingRules| { &mut m.tolerance },
        ));
...
impl ::protobuf::Message for HPAScalingRules {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.tolerance)?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.tolerance.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
    ...
    fn default_instance() -> &'static HPAScalingRules {
        static instance: HPAScalingRules = HPAScalingRules {
            ...
            tolerance: ::protobuf::MessageField::none(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x03\x20\x01(\x05R\rperiodSeconds\"\xfe\x01\n\x0fHPAScalingRules\x12\
    ...
    gPolicyR\x08policies\x12E\n\ttolerance\x18\x04\x20\x01(\x0b2'.apimachine\
    ry.pkg.api.resource.QuantityR\ttolerance\"\xf0\x01\n\x17HorizontalPodAut\
    oscaler\x12E\n\x08metadata\x18\x01\x20\x01(\x0b2).apimachinery.pkg.apis.\
    meta.v1.ObjectMetaR\x08metadata\x12C\n\x04spec\x18\x02\x20\x01(\x0b2/.ap\
    i.autoscaling.v2.HorizontalPodAutoscalerSpecR\x04spec\x12I\n\x06status\
    \x18\x03\x20\x01(\x0b21.api.autoscaling.v2.HorizontalPodAutoscalerStatus\
    R\x06status\"\xa3\x01\n\x1fHorizontalPodAutoscalerBehavior\x12=\n\x07sca\
    leUp\x18\x01\x20\x01(\x0b2#.api.autoscaling.v2.HPAScalingRulesR\x07scale\
    Up\x12A\n\tscaleDown\x18\x02\x20\x01(\x0b2#.api.autoscaling.v2.HPAScalin\
    gRulesR\tscaleDown\"\xd5\x01\n\x20HorizontalPodAutoscalerCondition\x12\
    ...
    \x20\x01(\tR\x07message\"\xa5\x01\n\x1bHorizontalPodAutoscalerList\x12C\
    \n\x08metadata\x18\x01\x20\x01(\x0b2'.apimachinery.pkg.apis.meta.v1.List\
    MetaR\x08metadata\x12A\n\x05items\x18\x02\x20\x03(\x0b2+.api.autoscaling\
    .v2.HorizontalPodAutoscalerR\x05items\"\xc5\x02\n\x1bHorizontalPodAutosc\
    alerSpec\x12W\n\x0escaleTargetRef\x18\x01\x20\x01(\x0b2/.api.autoscaling\
    .v2.CrossVersionObjectReferenceR\x0escaleTargetRef\x12\x20\n\x0bminRepli\
    cas\x18\x02\x20\x01(\x05R\x0bminReplicas\x12\x20\n\x0bmaxReplicas\x18\
    \x03\x20\x01(\x05R\x0bmaxReplicas\x128\n\x07metrics\x18\x04\x20\x03(\x0b\
    2\x1e.api.autoscaling.v2.MetricSpecR\x07metrics\x12O\n\x08behavior\x18\
    \x05\x20\x01(\x0b23.api.autoscaling.v2.HorizontalPodAutoscalerBehaviorR\
    \x08behavior\"\x8e\x03\n\x1dHorizontalPodAutoscalerStatus\x12.\n\x12obse\
    rvedGeneration\x18\x01\x20\x01(\x03R\x12observedGeneration\x12I\n\rlastS\
    caleTime\x18\x02\x20\x01(\x0b2#.apimachinery.pkg.apis.meta.v1.TimeR\rlas\
    tScaleTime\x12(\n\x0fcurrentReplicas\x18\x03\x20\x01(\x05R\x0fcurrentRep\
    licas\x12(\n\x0fdesiredReplicas\x18\x04\x20\x01(\x05R\x0fdesiredReplicas\
    \x12H\n\x0ecurrentMetrics\x18\x05\x20\x03(\x0b2\x20.api.autoscaling.v2.M\
    etricStatusR\x0ecurrentMetrics\x12T\n\nconditions\x18\x06\x20\x03(\x0b24\
    .api.autoscaling.v2.HorizontalPodAutoscalerConditionR\nconditions\"p\n\
    ...
    lSelectorR\x08selector\"\x87\x03\n\nMetricSpec\x12\x12\n\x04type\x18\x01\
    \x20\x01(\tR\x04type\x12>\n\x06object\x18\x02\x20\x01(\x0b2&.api.autosca\
    ling.v2.ObjectMetricSourceR\x06object\x128\n\x04pods\x18\x03\x20\x01(\
    \x0b2$.api.autoscaling.v2.PodsMetricSourceR\x04pods\x12D\n\x08resource\
    \x18\x04\x20\x01(\x0b2(.api.autoscaling.v2.ResourceMetricSourceR\x08reso\
    urce\x12_\n\x11containerResource\x18\x07\x20\x01(\x0b21.api.autoscaling.\
    v2.ContainerResourceMetricSourceR\x11containerResource\x12D\n\x08externa\
    l\x18\x05\x20\x01(\x0b2(.api.autoscaling.v2.ExternalMetricSourceR\x08ext\
    ernal\"\x89\x03\n\x0cMetricStatus\x12\x12\n\x04type\x18\x01\x20\x01(\tR\
    \x04type\x12>\n\x06object\x18\x02\x20\x01(\x0b2&.api.autoscaling.v2.Obje\
    ctMetricStatusR\x06object\x128\n\x04pods\x18\x03\x20\x01(\x0b2$.api.auto\
    scaling.v2.PodsMetricStatusR\x04pods\x12D\n\x08resource\x18\x04\x20\x01(\
    \x0b2(.api.autoscaling.v2.ResourceMetricStatusR\x08resource\x12_\n\x11co\
    ntainerResource\x18\x07\x20\x01(\x0b21.api.autoscaling.v2.ContainerResou\
    rceMetricStatusR\x11containerResource\x12D\n\x08external\x18\x05\x20\x01\
    (\x0b2(.api.autoscaling.v2.ExternalMetricStatusR\x08external\"\xde\x01\n\
    ...
    \x05value\x12K\n\x0caverageValue\x18\x03\x20\x01(\x0b2'.apimachinery.pkg\
    .api.resource.QuantityR\x0caverageValue\x12.\n\x12averageUtilization\x18\
    \x04\x20\x01(\x05R\x12averageUtilization\"\xcf\x01\n\x11MetricValueStatu\
    s\x12=\n\x05value\x18\x01\x20\x01(\x0b2'.apimachinery.pkg.api.resource.Q\
    uantityR\x05value\x12K\n\x0caverageValue\x18\x02\x20\x01(\x0b2'.apimachi\
    nery.pkg.api.resource.QuantityR\x0caverageValue\x12.\n\x12averageUtiliza\
    tion\x18\x03\x20\x01(\x05R\x12averageUtilization\"\xe7\x01\n\x12ObjectMe\
    tricSource\x12Y\n\x0fdescribedObject\x18\x01\x20\x01(\x0b2/.api.autoscal\
    ing.v2.CrossVersionObjectReferenceR\x0fdescribedObject\x128\n\x06target\
    \x18\x02\x20\x01(\x0b2\x20.api.autoscaling.v2.MetricTargetR\x06target\
    \x12<\n\x06metric\x18\x03\x20\x01(\x0b2$.api.autoscaling.v2.MetricIdenti\
    fierR\x06metric\"\xee\x01\n\x12ObjectMetricStatus\x12<\n\x06metric\x18\
    ...
    sR\x07current\x12Y\n\x0fdescribedObject\x18\x03\x20\x01(\x0b2/.api.autos\
    caling.v2.CrossVersionObjectReferenceR\x0fdescribedObject\"\x8a\x01\n\
    \x10PodsMetricSource\x12<\n\x06metric\x18\x01\x20\x01(\x0b2$.api.autosca\
    ling.v2.MetricIdentifierR\x06metric\x128\n\x06target\x18\x02\x20\x01(\
    \x0b2\x20.api.autoscaling.v2.MetricTargetR\x06target\"\x91\x01\n\x10Pods\
    MetricStatus\x12<\n\x06metric\x18\x01\x20\x01(\x0b2$.api.autoscaling.v2.\
    MetricIdentifierR\x06metric\x12?\n\x07current\x18\x02\x20\x01(\x0b2%.api\
    .autoscaling.v2.MetricValueStatusR\x07current\"d\n\x14ResourceMetricSour\
    ce\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x128\n\x06target\x18\
    \x02\x20\x01(\x0b2\x20.api.autoscaling.v2.MetricTargetR\x06target\"k\n\
    \x14ResourceMetricStatus\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\
    \x12?\n\x07current\x18\x02\x20\x01(\x0b2%.api.autoscaling.v2.MetricValue\
    StatusR\x07currentB\x1bZ\x19k8s.io/api/autoscaling/v2\
";
