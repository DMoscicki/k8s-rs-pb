...
pub struct LeaseSpec {
    ...
    pub acquireTime: ::protobuf::MessageField<crate::v1_31::apimachinery::pkg::apis::meta::v1::Time>,
    #[serde(with = "crate::v1_31::MessageFieldDef")]
    #[serde(default)]
...
impl LeaseSpec {
    ...
    pub fn acquireTime(&self) -> &crate::v1_31::apimachinery::pkg::apis::meta::v1::Time {
        self.acquireTime.as_ref().unwrap_or_else(|| <crate::v1_31::apimachinery::pkg::apis::meta::v1::Time as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_acquireTime(&mut self, v: crate::v1_31::apimachinery::pkg::apis::meta::v1::Time) {
        self.acquireTime = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_acquireTime(&mut self) -> &mut crate::v1_31::apimachinery::pkg::apis::meta::v1::Time {
        self.acquireTime.mut_or_insert_default()
    }

    // Take field
    pub fn take_acquireTime(&mut self) -> crate::v1_31::apimachinery::pkg::apis::meta::v1::Time {
        self.acquireTime.take().unwrap_or_else(|| crate::v1_31::apimachinery::pkg::apis::meta::v1::Time::new())
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    on.v1beta1.LeaseSpecR\x04spec\"\x87\x01\n\tLeaseList\x12C\n\x08metadata\
    \x18\x01\x20\x01(\x0b2'.apimachinery.pkg.apis.meta.v1.ListMetaR\x08metad\
    ata\x125\n\x05items\x18\x02\x20\x03(\x0b2\x1f.api.coordination.v1beta1.L\
    easeR\x05items\"\xed\x02\n\tLeaseSpec\x12&\n\x0eholderIdentity\x18\x01\
    \x20\x01(\tR\x0eholderIdentity\x122\n\x14leaseDurationSeconds\x18\x02\
    \x20\x01(\x05R\x14leaseDurationSeconds\x12J\n\x0bacquireTime\x18\x03\x20\
    \x01(\x0b2(.apimachinery.pkg.apis.meta.v1.MicroTimeR\x0bacquireTime\x12F\
    \n\trenewTime\x18\x04\x20\x01(\x0b2(.apimachinery.pkg.apis.meta.v1.Micro\
    TimeR\trenewTime\x12*\n\x10leaseTransitions\x18\x05\x20\x01(\x05R\x10lea\
    seTransitions\x12\x1a\n\x08strategy\x18\x06\x20\x01(\tR\x08strategy\x12(\
    \n\x0fpreferredHolder\x18\x07\x20\x01(\tR\x0fpreferredHolderB!Z\x1fk8s.i\
    o/api/coordination/v1beta1\
";
