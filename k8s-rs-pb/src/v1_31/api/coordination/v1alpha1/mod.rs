...
//! Generated file from `api/coordination/v1alpha1/generated.proto`
...
// @@protoc_insertion_point(message:api.coordination.v1alpha1.LeaseCandidate)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LeaseCandidate {
    // message fields
    #[serde(with = "crate::v1_31::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidate.metadata)
    pub metadata: ::protobuf::MessageField<crate::v1_31::apimachinery::pkg::apis::meta::v1::ObjectMeta>,
    #[serde(with = "crate::v1_31::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidate.spec)
    pub spec: ::protobuf::MessageField<LeaseCandidateSpec>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.coordination.v1alpha1.LeaseCandidate.special_fields)
...
impl LeaseCandidate {
    ...
    // optional .api.coordination.v1alpha1.LeaseCandidateSpec spec = 2;
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.coordination.v1alpha1.LeaseCandidateList)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LeaseCandidateList {
    // message fields
    #[serde(with = "crate::v1_31::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidateList.metadata)
    pub metadata: ::protobuf::MessageField<crate::v1_31::apimachinery::pkg::apis::meta::v1::ListMeta>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidateList.items)
    pub items: ::std::vec::Vec<LeaseCandidate>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.coordination.v1alpha1.LeaseCandidateList.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl LeaseCandidateList {
    ...
    // repeated .api.coordination.v1alpha1.LeaseCandidate items = 2;
...
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[serde(rename_all = "snake_case")]
// @@protoc_insertion_point(message:api.coordination.v1alpha1.LeaseCandidateSpec)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LeaseCandidateSpec {
    // message fields
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidateSpec.leaseName)
    pub leaseName: ::std::option::Option<::std::string::String>,
    #[serde(with = "crate::v1_31::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidateSpec.pingTime)
    pub pingTime: ::protobuf::MessageField<crate::v1_31::apimachinery::pkg::apis::meta::v1::Time>,
    #[serde(with = "crate::v1_31::MessageFieldDef")]
    #[serde(default)]
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidateSpec.renewTime)
    pub renewTime: ::protobuf::MessageField<crate::v1_31::apimachinery::pkg::apis::meta::v1::Time>,
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidateSpec.binaryVersion)
    pub binaryVersion: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidateSpec.emulationVersion)
    pub emulationVersion: ::std::option::Option<::std::string::String>,
    #[serde(default)]
    // @@protoc_insertion_point(field:api.coordination.v1alpha1.LeaseCandidateSpec.preferredStrategies)
    pub preferredStrategies: ::std::vec::Vec<::std::string::String>,
    // special fields
    #[serde(skip)]
    // @@protoc_insertion_point(special_field:api.coordination.v1alpha1.LeaseCandidateSpec.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl LeaseCandidateSpec {
    ...
    pub fn pingTime(&self) -> &crate::v1_31::apimachinery::pkg::apis::meta::v1::Time {
        self.pingTime.as_ref().unwrap_or_else(|| <crate::v1_31::apimachinery::pkg::apis::meta::v1::Time as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_pingTime(&mut self, v: crate::v1_31::apimachinery::pkg::apis::meta::v1::Time) {
        self.pingTime = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_pingTime(&mut self) -> &mut crate::v1_31::apimachinery::pkg::apis::meta::v1::Time {
        self.pingTime.mut_or_insert_default()
    }

    // Take field
    pub fn take_pingTime(&mut self) -> crate::v1_31::apimachinery::pkg::apis::meta::v1::Time {
        self.pingTime.take().unwrap_or_else(|| crate::v1_31::apimachinery::pkg::apis::meta::v1::Time::new())
    }

    // optional .apimachinery.pkg.apis.meta.v1.MicroTime renewTime = 3;

    pub fn renewTime(&self) -> &crate::v1_31::apimachinery::pkg::apis::meta::v1::Time {
        self.renewTime.as_ref().unwrap_or_else(|| <crate::v1_31::apimachinery::pkg::apis::meta::v1::Time as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_renewTime(&mut self, v: crate::v1_31::apimachinery::pkg::apis::meta::v1::Time) {
        self.renewTime = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_renewTime(&mut self) -> &mut crate::v1_31::apimachinery::pkg::apis::meta::v1::Time {
        self.renewTime.mut_or_insert_default()
    }

    // Take field
    pub fn take_renewTime(&mut self) -> crate::v1_31::apimachinery::pkg::apis::meta::v1::Time {
        self.renewTime.take().unwrap_or_else(|| crate::v1_31::apimachinery::pkg::apis::meta::v1::Time::new())
    }
    ...
    pub fn preferredStrategies(&self) -> &[::std::string::String] {
        &self.preferredStrategies
    }

    pub fn clear_preferredStrategies(&mut self) {
        self.preferredStrategies.clear();
    }

    // Param is passed by value, moved
    pub fn set_preferredStrategies(&mut self, v: ::std::vec::Vec<::std::string::String>) {
        self.preferredStrategies = v;
    }

    // Mutable pointer to the field.
    pub fn mut_preferredStrategies(&mut self) -> &mut ::std::vec::Vec<::std::string::String> {
        &mut self.preferredStrategies
    }

    // Take field
    pub fn take_preferredStrategies(&mut self) -> ::std::vec::Vec<::std::string::String> {
        ::std::mem::replace(&mut self.preferredStrategies, ::std::vec::Vec::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "preferredStrategies",
            |m: &LeaseCandidateSpec| { &m.preferredStrategies },
            |m: &mut LeaseCandidateSpec| { &mut m.preferredStrategies },
        ));
...
impl ::protobuf::Message for LeaseCandidateSpec {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                50 => {
                    self.preferredStrategies.push(is.read_string()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.preferredStrategies {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        for v in &self.preferredStrategies {
            os.write_string(6, &v)?;
        };
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    ...
    fn default_instance() -> &'static LeaseCandidateSpec {
        static instance: LeaseCandidateSpec = LeaseCandidateSpec {
            ...
            preferredStrategies: ::std::vec::Vec::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n)api/coordination/v1alpha1/generated.proto\x12\x19api.coordination.v1a\
    lpha1\x1a#api/coordination/v1/generated.proto\x1a-apimachinery/pkg/apis/\
    ...
    \tR\x10emulationVersion\x120\n\x13preferredStrategies\x18\x06\x20\x03(\t\
    R\x13preferredStrategiesB\"Z\x20k8s.io/api/coordination/v1alpha1\
";
