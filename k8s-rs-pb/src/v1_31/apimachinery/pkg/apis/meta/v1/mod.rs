...
pub struct List {
    ...
    pub items: ::std::vec::Vec<crate::v1_31::apimachinery::pkg::runtime::RawExtension>,
    // special fields
    #[serde(skip)]
...
impl List {
    ...
    pub fn items(&self) -> &[crate::v1_31::apimachinery::pkg::runtime::RawExtension] {
        &self.items
    }
    ...
    // Param is passed by value, moved
    pub fn set_items(&mut self, v: ::std::vec::Vec<crate::v1_31::apimachinery::pkg::runtime::RawExtension>) {
        self.items = v;
    }

    // Mutable pointer to the field.
    pub fn mut_items(&mut self) -> &mut ::std::vec::Vec<crate::v1_31::apimachinery::pkg::runtime::RawExtension> {
        &mut self.items
    }

    // Take field
    pub fn take_items(&mut self) -> ::std::vec::Vec<crate::v1_31::apimachinery::pkg::runtime::RawExtension> {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    lues\x18\x03\x20\x03(\tR\x06values\"\x1c\n\x08FieldsV1\x12\x10\n\x03Raw\
    \x18\x01\x20\x01(\x0cR\x03Raw\"6\n\nGetOptions\x12(\n\x0fresourceVersion\
    \x18\x01\x20\x01(\tR\x0fresourceVersion\"5\n\tGroupKind\x12\x14\n\x05gro\
    up\x18\x01\x20\x01(\tR\x05group\x12\x12\n\x04kind\x18\x02\x20\x01(\tR\
    \x04kind\"A\n\rGroupResource\x12\x14\n\x05group\x18\x01\x20\x01(\tR\x05g\
    roup\x12\x1a\n\x08resource\x18\x02\x20\x01(\tR\x08resource\">\n\x0cGroup\
    Version\x12\x14\n\x05group\x18\x01\x20\x01(\tR\x05group\x12\x18\n\x07ver\
    sion\x18\x02\x20\x01(\tR\x07version\"X\n\x18GroupVersionForDiscovery\x12\
    \"\n\x0cgroupVersion\x18\x01\x20\x01(\tR\x0cgroupVersion\x12\x18\n\x07ve\
    rsion\x18\x02\x20\x01(\tR\x07version\"V\n\x10GroupVersionKind\x12\x14\n\
    ...
    ce\x18\x03\x20\x01(\tR\x08resource\"\x95\x02\n\rLabelSelector\x12_\n\x0b\
    matchLabels\x18\x01\x20\x03(\x0b2=.apimachinery.pkg.apis.meta.v1.LabelSe\
    lector.MatchLabelsEntryR\x0bmatchLabels\x12c\n\x10matchExpressions\x18\
    \x02\x20\x03(\x0b27.apimachinery.pkg.apis.meta.v1.LabelSelectorRequireme\
    ntR\x10matchExpressions\x1a>\n\x10MatchLabelsEntry\x12\x10\n\x03key\x18\
    ...
    .ListMetaR\x08metadata\x12<\n\x05items\x18\x02\x20\x03(\x0b2&.apimachine\
    ry.pkg.runtime.RawExtensionR\x05items\"\x9c\x01\n\x08ListMeta\x12\x1a\n\
    \x08selfLink\x18\x01\x20\x01(\tR\x08selfLink\x12(\n\x0fresourceVersion\
    \x18\x02\x20\x01(\tR\x0fresourceVersion\x12\x1a\n\x08continue\x18\x03\
    \x20\x01(\tR\x08continue\x12.\n\x12remainingItemCount\x18\x04\x20\x01(\
    \x03R\x12remainingItemCount\"\x87\x03\n\x0bListOptions\x12$\n\rlabelSele\
    ctor\x18\x01\x20\x01(\tR\rlabelSelector\x12$\n\rfieldSelector\x18\x02\
    \x20\x01(\tR\rfieldSelector\x12\x14\n\x05watch\x18\x03\x20\x01(\x08R\x05\
    watch\x120\n\x13allowWatchBookmarks\x18\t\x20\x01(\x08R\x13allowWatchBoo\
    kmarks\x12(\n\x0fresourceVersion\x18\x04\x20\x01(\tR\x0fresourceVersion\
    \x122\n\x14resourceVersionMatch\x18\n\x20\x01(\tR\x14resourceVersionMatc\
    h\x12&\n\x0etimeoutSeconds\x18\x05\x20\x01(\x03R\x0etimeoutSeconds\x12\
    \x14\n\x05limit\x18\x07\x20\x01(\x03R\x05limit\x12\x1a\n\x08continue\x18\
    \x08\x20\x01(\tR\x08continue\x12,\n\x11sendInitialEvents\x18\x0b\x20\x01\
    (\x08R\x11sendInitialEvents\"\xac\x02\n\x12ManagedFieldsEntry\x12\x18\n\
    \x07manager\x18\x01\x20\x01(\tR\x07manager\x12\x1c\n\toperation\x18\x02\
    \x20\x01(\tR\toperation\x12\x1e\n\napiVersion\x18\x03\x20\x01(\tR\napiVe\
    rsion\x127\n\x04time\x18\x04\x20\x01(\x0b2#.apimachinery.pkg.apis.meta.v\
    1.TimeR\x04time\x12\x1e\n\nfieldsType\x18\x06\x20\x01(\tR\nfieldsType\
    \x12C\n\x08fieldsV1\x18\x07\x20\x01(\x0b2'.apimachinery.pkg.apis.meta.v1\
    .FieldsV1R\x08fieldsV1\x12\x20\n\x0bsubresource\x18\x08\x20\x01(\tR\x0bs\
    ...
    \x20\x01(\x0b2#.apimachinery.pkg.apis.meta.v1.TimeR\x11creationTimestamp\
    \x12Q\n\x11deletionTimestamp\x18\t\x20\x01(\x0b2#.apimachinery.pkg.apis.\
    meta.v1.TimeR\x11deletionTimestamp\x12>\n\x1adeletionGracePeriodSeconds\
    \x18\n\x20\x01(\x03R\x1adeletionGracePeriodSeconds\x12M\n\x06labels\x18\
    \x0b\x20\x03(\x0b25.apimachinery.pkg.apis.meta.v1.ObjectMeta.LabelsEntry\
    R\x06labels\x12\\\n\x0bannotations\x18\x0c\x20\x03(\x0b2:.apimachinery.p\
    kg.apis.meta.v1.ObjectMeta.AnnotationsEntryR\x0bannotations\x12W\n\x0fow\
    nerReferences\x18\r\x20\x03(\x0b2-.apimachinery.pkg.apis.meta.v1.OwnerRe\
    ferenceR\x0fownerReferences\x12\x1e\n\nfinalizers\x18\x0e\x20\x03(\tR\nf\
    inalizers\x12W\n\rmanagedFields\x18\x11\x20\x03(\x0b21.apimachinery.pkg.\
    apis.meta.v1.ManagedFieldsEntryR\rmanagedFields\x1a9\n\x0bLabelsEntry\
    \x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\
    \x20\x01(\tR\x05value:\x028\x01\x1a>\n\x10AnnotationsEntry\x12\x10\n\x03\
    key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\
    \x05value:\x028\x01\"\xba\x01\n\x0eOwnerReference\x12\x1e\n\napiVersion\
    \x18\x05\x20\x01(\tR\napiVersion\x12\x12\n\x04kind\x18\x01\x20\x01(\tR\
    \x04kind\x12\x12\n\x04name\x18\x03\x20\x01(\tR\x04name\x12\x10\n\x03uid\
    \x18\x04\x20\x01(\tR\x03uid\x12\x1e\n\ncontroller\x18\x06\x20\x01(\x08R\
    \ncontroller\x12.\n\x12blockOwnerDeletion\x18\x07\x20\x01(\x08R\x12block\
    ...
    \x01(\x0b2'.apimachinery.pkg.apis.meta.v1.ListMetaR\x08metadata\x12J\n\
    \x05items\x18\x02\x20\x03(\x0b24.apimachinery.pkg.apis.meta.v1.PartialOb\
    jectMetadataR\x05items\"\x07\n\x05Patch\"\x8a\x01\n\x0cPatchOptions\x12\
    \x16\n\x06dryRun\x18\x01\x20\x03(\tR\x06dryRun\x12\x14\n\x05force\x18\
    \x02\x20\x01(\x08R\x05force\x12\"\n\x0cfieldManager\x18\x03\x20\x01(\tR\
    \x0cfieldManager\x12(\n\x0ffieldValidation\x18\x04\x20\x01(\tR\x0ffieldV\
    alidation\"K\n\rPreconditions\x12\x10\n\x03uid\x18\x01\x20\x01(\tR\x03ui\
    d\x12(\n\x0fresourceVersion\x18\x02\x20\x01(\tR\x0fresourceVersion\"!\n\
    \tRootPaths\x12\x14\n\x05paths\x18\x01\x20\x03(\tR\x05paths\"a\n\x19Serv\
    erAddressByClientCIDR\x12\x1e\n\nclientCIDR\x18\x01\x20\x01(\tR\nclientC\
    IDR\x12$\n\rserverAddress\x18\x02\x20\x01(\tR\rserverAddress\"\xf3\x01\n\
    \x06Status\x12C\n\x08metadata\x18\x01\x20\x01(\x0b2'.apimachinery.pkg.ap\
    is.meta.v1.ListMetaR\x08metadata\x12\x16\n\x06status\x18\x02\x20\x01(\tR\
    \x06status\x12\x18\n\x07message\x18\x03\x20\x01(\tR\x07message\x12\x16\n\
    \x06reason\x18\x04\x20\x01(\tR\x06reason\x12F\n\x07details\x18\x05\x20\
    \x01(\x0b2,.apimachinery.pkg.apis.meta.v1.StatusDetailsR\x07details\x12\
    \x12\n\x04code\x18\x06\x20\x01(\x05R\x04code\"U\n\x0bStatusCause\x12\x16\
    \n\x06reason\x18\x01\x20\x01(\tR\x06reason\x12\x18\n\x07message\x18\x02\
    \x20\x01(\tR\x07message\x12\x14\n\x05field\x18\x03\x20\x01(\tR\x05field\
    \"\xd1\x01\n\rStatusDetails\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04nam\
    e\x12\x14\n\x05group\x18\x02\x20\x01(\tR\x05group\x12\x12\n\x04kind\x18\
    \x03\x20\x01(\tR\x04kind\x12\x10\n\x03uid\x18\x06\x20\x01(\tR\x03uid\x12\
    B\n\x06causes\x18\x04\x20\x03(\x0b2*.apimachinery.pkg.apis.meta.v1.Statu\
    sCauseR\x06causes\x12,\n\x11retryAfterSeconds\x18\x05\x20\x01(\x05R\x11r\
    etryAfterSeconds\"4\n\x0cTableOptions\x12$\n\rincludeObject\x18\x01\x20\
    \x01(\tR\rincludeObject\"6\n\x04Time\x12\x18\n\x07seconds\x18\x01\x20\
    \x01(\x03R\x07seconds\x12\x14\n\x05nanos\x18\x02\x20\x01(\x05R\x05nanos\
    \";\n\tTimestamp\x12\x18\n\x07seconds\x18\x01\x20\x01(\x03R\x07seconds\
    \x12\x14\n\x05nanos\x18\x02\x20\x01(\x05R\x05nanos\">\n\x08TypeMeta\x12\
    \x12\n\x04kind\x18\x01\x20\x01(\tR\x04kind\x12\x1e\n\napiVersion\x18\x02\
    \x20\x01(\tR\napiVersion\"u\n\rUpdateOptions\x12\x16\n\x06dryRun\x18\x01\
    \x20\x03(\tR\x06dryRun\x12\"\n\x0cfieldManager\x18\x02\x20\x01(\tR\x0cfi\
    eldManager\x12(\n\x0ffieldValidation\x18\x03\x20\x01(\tR\x0ffieldValidat\
    ion\"\x1d\n\x05Verbs\x12\x14\n\x05items\x18\x01\x20\x03(\tR\x05items\"`\
    \n\nWatchEvent\x12\x12\n\x04type\x18\x01\x20\x01(\tR\x04type\x12>\n\x06o\
    bject\x18\x02\x20\x01(\x0b2&.apimachinery.pkg.runtime.RawExtensionR\x06o\
    bjectB&Z$k8s.io/apimachinery/pkg/apis/meta/v1\
";
