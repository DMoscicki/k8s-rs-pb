...
pub mod converter {
    ...
    /// 
    /// ``` 
    /// use k8s_rs_pb::v1_31::api::core::v1::Pod;
    /// use k8s_openapi::api::core::v1::Pod as OtherPod;
    /// 
    /// let pod_openapi = OtherPod::default();
    /// let pod_pb: Pod = k8s_rs_pb::v1_31::converter::from_openapi(pod_openapi).unwrap();
    ...
    /// let pod_openapi: OtherPod = k8s_rs_pb::v1_31::converter::to_openapi(pod_pb).unwrap();
    /// 
