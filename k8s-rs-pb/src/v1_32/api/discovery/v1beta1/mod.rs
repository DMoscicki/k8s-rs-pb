...
pub struct Endpoint {
    ...
    pub targetRef: ::protobuf::MessageField<crate::v1_32::api::core::v1::ObjectReference>,
    #[serde(default)]
...
impl Endpoint {
    ...
    pub fn targetRef(&self) -> &crate::v1_32::api::core::v1::ObjectReference {
        self.targetRef.as_ref().unwrap_or_else(|| <crate::v1_32::api::core::v1::ObjectReference as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_targetRef(&mut self, v: crate::v1_32::api::core::v1::ObjectReference) {
        self.targetRef = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_targetRef(&mut self) -> &mut crate::v1_32::api::core::v1::ObjectReference {
        self.targetRef.mut_or_insert_default()
    }

    // Take field
    pub fn take_targetRef(&mut self) -> crate::v1_32::api::core::v1::ObjectReference {
        self.targetRef.take().unwrap_or_else(|| crate::v1_32::api::core::v1::ObjectReference::new())
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0bterminating\x18\x03\x20\x01(\x08R\x0bterminating\"K\n\rEndpointHin\
    ts\x12:\n\x08forZones\x18\x01\x20\x03(\x0b2\x1e.api.discovery.v1beta1.Fo\
    rZoneR\x08forZones\"t\n\x0cEndpointPort\x12\x12\n\x04name\x18\x01\x20\
    \x01(\tR\x04name\x12\x1a\n\x08protocol\x18\x02\x20\x01(\tR\x08protocol\
    \x12\x12\n\x04port\x18\x03\x20\x01(\x05R\x04port\x12\x20\n\x0bappProtoco\
    l\x18\x04\x20\x01(\tR\x0bappProtocol\"\xf2\x01\n\rEndpointSlice\x12E\n\
    \x08metadata\x18\x01\x20\x01(\x0b2).apimachinery.pkg.apis.meta.v1.Object\
    MetaR\x08metadata\x12\x20\n\x0baddressType\x18\x04\x20\x01(\tR\x0baddres\
    sType\x12=\n\tendpoints\x18\x02\x20\x03(\x0b2\x1f.api.discovery.v1beta1.\
    EndpointR\tendpoints\x129\n\x05ports\x18\x03\x20\x03(\x0b2#.api.discover\
    y.v1beta1.EndpointPortR\x05ports\"\x94\x01\n\x11EndpointSliceList\x12C\n\
    \x08metadata\x18\x01\x20\x01(\x0b2'.apimachinery.pkg.apis.meta.v1.ListMe\
    taR\x08metadata\x12:\n\x05items\x18\x02\x20\x03(\x0b2$.api.discovery.v1b\
    eta1.EndpointSliceR\x05items\"\x1d\n\x07ForZone\x12\x12\n\x04name\x18\
    \x01\x20\x01(\tR\x04nameB\x1eZ\x1ck8s.io/api/discovery/v1beta1\
";
