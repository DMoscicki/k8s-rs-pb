...
pub struct LeaseCandidateSpec {
    ...
    pub pingTime: ::protobuf::MessageField<crate::v1_32::apimachinery::pkg::apis::meta::v1::Time>,
    #[serde(with = "crate::v1_32::MessageFieldDef")]
    #[serde(default)]
...
impl LeaseCandidateSpec {
    ...
    pub fn pingTime(&self) -> &crate::v1_32::apimachinery::pkg::apis::meta::v1::Time {
        self.pingTime.as_ref().unwrap_or_else(|| <crate::v1_32::apimachinery::pkg::apis::meta::v1::Time as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_pingTime(&mut self, v: crate::v1_32::apimachinery::pkg::apis::meta::v1::Time) {
        self.pingTime = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_pingTime(&mut self) -> &mut crate::v1_32::apimachinery::pkg::apis::meta::v1::Time {
        self.pingTime.mut_or_insert_default()
    }

    // Take field
    pub fn take_pingTime(&mut self) -> crate::v1_32::apimachinery::pkg::apis::meta::v1::Time {
        self.pingTime.take().unwrap_or_else(|| crate::v1_32::apimachinery::pkg::apis::meta::v1::Time::new())
    }
