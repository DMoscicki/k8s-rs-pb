...
pub struct BasicDevice {
    ...
    pub capacity: ::std::collections::BTreeMap<::std::string::String, crate::v1_32::apimachinery::pkg::api::resource::Quantity>,
    // special fields
    #[serde(skip)]
...
impl BasicDevice {
    ...
    pub fn capacity(&self) -> &::std::collections::BTreeMap<::std::string::String, crate::v1_32::apimachinery::pkg::api::resource::Quantity> {
        &self.capacity
    }
    ...
    // Param is passed by value, moved
    pub fn set_capacity(&mut self, v: ::std::collections::BTreeMap<::std::string::String, crate::v1_32::apimachinery::pkg::api::resource::Quantity>) {
        self.capacity = v;
    }

    // Mutable pointer to the field.
    pub fn mut_capacity(&mut self) -> &mut ::std::collections::BTreeMap<::std::string::String, crate::v1_32::apimachinery::pkg::api::resource::Quantity> {
        &mut self.capacity
    }

    // Take field
    pub fn take_capacity(&mut self) -> ::std::collections::BTreeMap<::std::string::String, crate::v1_32::apimachinery::pkg::api::resource::Quantity> {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\x0b2\x19.api.core.v1.NodeSelectorR\x0cnodeSelector\"\xfc\x02\n\x0b\
    ...
    ey\x12<\n\x05value\x18\x02\x20\x01(\x0b2&.api.resource.v1alpha3.DeviceAt\
    tributeR\x05value:\x028\x01\x1ad\n\rCapacityEntry\x12\x10\n\x03key\x18\
    \x01\x20\x01(\tR\x03key\x12=\n\x05value\x18\x02\x20\x01(\x0b2'.apimachin\
    ery.pkg.api.resource.QuantityR\x05value:\x028\x01\"3\n\x11CELDeviceSelec\
    tor\x12\x1e\n\nexpression\x18\x01\x20\x01(\tR\nexpression\"V\n\x06Device\
    \x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x128\n\x05basic\x18\x02\
    \x20\x01(\x0b2\".api.resource.v1alpha3.BasicDeviceR\x05basic\"\xb1\x01\n\
    \x1dDeviceAllocationConfiguration\x12\x16\n\x06source\x18\x01\x20\x01(\t\
    R\x06source\x12\x1a\n\x08requests\x18\x02\x20\x03(\tR\x08requests\x12\\\
    \n\x13deviceConfiguration\x18\x03\x20\x01(\x0b2*.api.resource.v1alpha3.D\
    eviceConfigurationR\x13deviceConfiguration\"\xb6\x01\n\x16DeviceAllocati\
    onResult\x12N\n\x07results\x18\x01\x20\x03(\x0b24.api.resource.v1alpha3.\
    DeviceRequestAllocationResultR\x07results\x12L\n\x06config\x18\x02\x20\
    \x03(\x0b24.api.resource.v1alpha3.DeviceAllocationConfigurationR\x06conf\
    ig\"i\n\x0fDeviceAttribute\x12\x10\n\x03int\x18\x02\x20\x01(\x03R\x03int\
    \x12\x12\n\x04bool\x18\x03\x20\x01(\x08R\x04bool\x12\x16\n\x06string\x18\
    \x04\x20\x01(\tR\x06string\x12\x18\n\x07version\x18\x05\x20\x01(\tR\x07v\
    ersion\"\xe3\x01\n\x0bDeviceClaim\x12@\n\x08requests\x18\x01\x20\x03(\
    \x0b2$.api.resource.v1alpha3.DeviceRequestR\x08requests\x12I\n\x0bconstr\
    aints\x18\x02\x20\x03(\x0b2'.api.resource.v1alpha3.DeviceConstraintR\x0b\
    constraints\x12G\n\x06config\x18\x03\x20\x03(\x0b2/.api.resource.v1alpha\
    3.DeviceClaimConfigurationR\x06config\"\x94\x01\n\x18DeviceClaimConfigur\
    ation\x12\x1a\n\x08requests\x18\x01\x20\x03(\tR\x08requests\x12\\\n\x13d\
    eviceConfiguration\x18\x02\x20\x01(\x0b2*.api.resource.v1alpha3.DeviceCo\
    nfigurationR\x13deviceConfiguration\"\x90\x01\n\x0bDeviceClass\x12E\n\
    ...
    lpha3.DeviceClassSpecR\x04spec\"x\n\x18DeviceClassConfiguration\x12\\\n\
    \x13deviceConfiguration\x18\x01\x20\x01(\x0b2*.api.resource.v1alpha3.Dev\
    iceConfigurationR\x13deviceConfiguration\"\x90\x01\n\x0fDeviceClassList\
    \x12C\n\x08metadata\x18\x01\x20\x01(\x0b2'.apimachinery.pkg.apis.meta.v1\
    .ListMetaR\x08metadata\x128\n\x05items\x18\x02\x20\x03(\x0b2\".api.resou\
    rce.v1alpha3.DeviceClassR\x05items\"\x9f\x01\n\x0fDeviceClassSpec\x12C\n\
    \tselectors\x18\x01\x20\x03(\x0b2%.api.resource.v1alpha3.DeviceSelectorR\
    \tselectors\x12G\n\x06config\x18\x02\x20\x03(\x0b2/.api.resource.v1alpha\
    3.DeviceClassConfigurationR\x06config\"_\n\x13DeviceConfiguration\x12H\n\
    \x06opaque\x18\x01\x20\x01(\x0b20.api.resource.v1alpha3.OpaqueDeviceConf\
    igurationR\x06opaque\"V\n\x10DeviceConstraint\x12\x1a\n\x08requests\x18\
    \x01\x20\x03(\tR\x08requests\x12&\n\x0ematchAttribute\x18\x02\x20\x01(\t\
    R\x0ematchAttribute\"\xf2\x01\n\rDeviceRequest\x12\x12\n\x04name\x18\x01\
    \x20\x01(\tR\x04name\x12(\n\x0fdeviceClassName\x18\x02\x20\x01(\tR\x0fde\
    viceClassName\x12C\n\tselectors\x18\x03\x20\x03(\x0b2%.api.resource.v1al\
    pha3.DeviceSelectorR\tselectors\x12&\n\x0eallocationMode\x18\x04\x20\x01\
    (\tR\x0eallocationMode\x12\x14\n\x05count\x18\x05\x20\x01(\x03R\x05count\
    \x12\x20\n\x0badminAccess\x18\x06\x20\x01(\x08R\x0badminAccess\"\x9f\x01\
    ...
    \x0b2(.api.resource.v1alpha3.CELDeviceSelectorR\x03cel\"u\n\x11NetworkDe\
    viceData\x12$\n\rinterfaceName\x18\x01\x20\x01(\tR\rinterfaceName\x12\
    \x10\n\x03ips\x18\x02\x20\x03(\tR\x03ips\x12(\n\x0fhardwareAddress\x18\
    \x03\x20\x01(\tR\x0fhardwareAddress\"{\n\x19OpaqueDeviceConfiguration\
    \x12\x16\n\x06driver\x18\x01\x20\x01(\tR\x06driver\x12F\n\nparameters\
    \x18\x02\x20\x01(\x0b2&.apimachinery.pkg.runtime.RawExtensionR\nparamete\
    rs\"\xd8\x01\n\rResourceClaim\x12E\n\x08metadata\x18\x01\x20\x01(\x0b2).\
    apimachinery.pkg.apis.meta.v1.ObjectMetaR\x08metadata\x12<\n\x04spec\x18\
    \x02\x20\x01(\x0b2(.api.resource.v1alpha3.ResourceClaimSpecR\x04spec\x12\
    B\n\x06status\x18\x03\x20\x01(\x0b2*.api.resource.v1alpha3.ResourceClaim\
    StatusR\x06status\"~\n\x1eResourceClaimConsumerReference\x12\x1a\n\x08ap\
    iGroup\x18\x01\x20\x01(\tR\x08apiGroup\x12\x1a\n\x08resource\x18\x03\x20\
    \x01(\tR\x08resource\x12\x12\n\x04name\x18\x04\x20\x01(\tR\x04name\x12\
    ...
    rce.v1alpha3.ResourceClaimR\x05items\"Q\n\x11ResourceClaimSpec\x12<\n\
    \x07devices\x18\x01\x20\x01(\x0b2\".api.resource.v1alpha3.DeviceClaimR\
    \x07devices\"\xff\x01\n\x13ResourceClaimStatus\x12G\n\nallocation\x18\
    \x01\x20\x01(\x0b2'.api.resource.v1alpha3.AllocationResultR\nallocation\
    \x12W\n\x0breservedFor\x18\x02\x20\x03(\x0b25.api.resource.v1alpha3.Reso\
    urceClaimConsumerReferenceR\x0breservedFor\x12F\n\x07devices\x18\x04\x20\
    \x03(\x0b2,.api.resource.v1alpha3.AllocatedDeviceStatusR\x07devices\"\
    \xa4\x01\n\x15ResourceClaimTemplate\x12E\n\x08metadata\x18\x01\x20\x01(\
    \x0b2).apimachinery.pkg.apis.meta.v1.ObjectMetaR\x08metadata\x12D\n\x04s\
    pec\x18\x02\x20\x01(\x0b20.api.resource.v1alpha3.ResourceClaimTemplateSp\
    ...
    rce.v1alpha3.DeviceR\x07devicesB\x1eZ\x1ck8s.io/api/resource/v1alpha3\
";
