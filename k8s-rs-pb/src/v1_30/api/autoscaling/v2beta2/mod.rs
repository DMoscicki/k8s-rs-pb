...
pub struct MetricTarget {
    ...
    pub value: ::protobuf::MessageField<crate::v1_30::apimachinery::pkg::api::resource::Quantity>,
    #[serde(with = "crate::v1_30::MessageFieldDef")]
    #[serde(default)]
...
impl MetricTarget {
    ...
    pub fn value(&self) -> &crate::v1_30::apimachinery::pkg::api::resource::Quantity {
        self.value.as_ref().unwrap_or_else(|| <crate::v1_30::apimachinery::pkg::api::resource::Quantity as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_value(&mut self, v: crate::v1_30::apimachinery::pkg::api::resource::Quantity) {
        self.value = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_value(&mut self) -> &mut crate::v1_30::apimachinery::pkg::api::resource::Quantity {
        self.value.mut_or_insert_default()
    }

    // Take field
    pub fn take_value(&mut self) -> crate::v1_30::apimachinery::pkg::api::resource::Quantity {
        self.value.take().unwrap_or_else(|| crate::v1_30::apimachinery::pkg::api::resource::Quantity::new())
    }
