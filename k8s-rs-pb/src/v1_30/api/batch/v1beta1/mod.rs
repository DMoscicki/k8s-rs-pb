...
pub struct JobTemplateSpec {
    ...
    pub spec: ::protobuf::MessageField<crate::v1_30::api::batch::v1::JobSpec>,
    // special fields
    #[serde(skip)]
...
impl JobTemplateSpec {
    ...
    pub fn spec(&self) -> &crate::v1_30::api::batch::v1::JobSpec {
        self.spec.as_ref().unwrap_or_else(|| <crate::v1_30::api::batch::v1::JobSpec as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_spec(&mut self, v: crate::v1_30::api::batch::v1::JobSpec) {
        self.spec = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_spec(&mut self) -> &mut crate::v1_30::api::batch::v1::JobSpec {
        self.spec.mut_or_insert_default()
    }

    // Take field
    pub fn take_spec(&mut self) -> crate::v1_30::api::batch::v1::JobSpec {
        self.spec.take().unwrap_or_else(|| crate::v1_30::api::batch::v1::JobSpec::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, crate::v1_30::api::batch::v1::JobSpec>(
            "spec",
