...
pub struct MutatingWebhook {
    ...
    pub rules: ::std::vec::Vec<crate::api::admissionregistration::v1::RuleWithOperations>,
...
impl MutatingWebhook {
    ...
    pub fn rules(&self) -> &[crate::api::admissionregistration::v1::RuleWithOperations] {
        &self.rules
    }
    ...
    // Param is passed by value, moved
    pub fn set_rules(&mut self, v: ::std::vec::Vec<crate::api::admissionregistration::v1::RuleWithOperations>) {
        self.rules = v;
    }

    // Mutable pointer to the field.
    pub fn mut_rules(&mut self) -> &mut ::std::vec::Vec<crate::api::admissionregistration::v1::RuleWithOperations> {
        &mut self.rules
    }

    // Take field
    pub fn take_rules(&mut self) -> ::std::vec::Vec<crate::api::admissionregistration::v1::RuleWithOperations> {
