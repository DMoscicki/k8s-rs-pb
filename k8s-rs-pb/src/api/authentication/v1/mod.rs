...
impl TokenRequestStatus {
    ...
    pub fn expirationTimestamp(&self) -> &crate::apimachinery::pkg::apis::meta::v1::Time {
        self.expirationTimestamp.as_ref().unwrap_or_else(|| <crate::apimachinery::pkg::apis::meta::v1::Time as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_expirationTimestamp(&mut self, v: crate::apimachinery::pkg::apis::meta::v1::Time) {
        self.expirationTimestamp = ::protobuf::MessageField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_expirationTimestamp(&mut self) -> &mut crate::apimachinery::pkg::apis::meta::v1::Time {
        self.expirationTimestamp.mut_or_insert_default()
    }

    // Take field
    pub fn take_expirationTimestamp(&mut self) -> crate::apimachinery::pkg::apis::meta::v1::Time {
        self.expirationTimestamp.take().unwrap_or_else(|| crate::apimachinery::pkg::apis::meta::v1::Time::new())
    }
